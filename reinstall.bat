...
set confhome=https://raw.githubusercontent.com/BayuXD-Tunnel/reinstall/main
set confhome_cn=https://www.ghproxy.cc/https://raw.githubusercontent.com/BayuXD-Tunnel/reinstall/main
rem set confhome_cn=https://jihulab.com/BayuXD-Tunnel/reinstall/-/raw/main
