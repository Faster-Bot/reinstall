...
set -eE
confhome=https://raw.githubusercontent.com/BayuXD-Tunnel/reinstall/main
confhome_cn=https://www.ghproxy.cc/https://raw.githubusercontent.com/BayuXD-Tunnel/reinstall/main
# confhome_cn=https://jihulab.com/BayuXD-Tunnel/reinstall/-/raw/main
...
Manual: https://github.com/BayuXD-Tunnel/reinstall
...
prompt_password() {
    ...
    if [ -z "$password" ]; then
        error "Password is empty. Try again."
